...
def analyze_battle_results(file_path='battle_results.json'):
    ...
    try:
        ...
        pivot_df = df.pivot_table(index='scenario_name', columns='winner', aggfunc='size', fill_value=0)
        
        # Normalizacja do 100%
        pivot_pct = pivot_df.div(pivot_df.sum(axis=1), axis=0) * 100
        
        ax = pivot_pct.plot(kind='barh', stacked=True, figsize=(12, 8), colormap='coolwarm')
