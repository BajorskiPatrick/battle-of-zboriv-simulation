...
Mimo spójnych wyników, zauważono pewne uproszczenia / ograniczenia symulacji:
\begin{itemize}
    \item \textbf{Brak obsługi "kompletnej ucieczki" jednostek:} W przypadku, gdy jednostki uciekną na krawędź mapy, jednostki przeciwne będą je ścigać, aby je wyeliminować. W rzeczywistości jednostki mogłyby kompletnie uciec z pola bitwy i zostać potraktowane jako pokonane. Może to wpływać na wydłużenie czasu trwania bitew, np. w sytuacji, gdy jednostki muszą przebyć dużą odległość, aby wyeliminować zbiegłą jednostkę.
