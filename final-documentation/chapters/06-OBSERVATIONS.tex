...
\begin{itemize}
    ...
    \item \textbf{Wniosek:} Mimo wyższej dyscypliny Piechoty Niemieckiej (95 vs 80), parametry bojowe obu jednostek są zbliżone (Niemcy: HP 110, Rate of Fire 1.3; Kozacy: HP 115, Rate of Fire 1.4). Przewaga liczebna (15 do 10) po stronie kozackiej, w połączeniu z nieco wyższą szybkostrzelnością, okazała się decydująca w wymianie ogniowej.
\end{itemize}
